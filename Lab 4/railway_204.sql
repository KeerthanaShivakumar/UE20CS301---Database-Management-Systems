...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 29, 2022 at 12:02 PM
...
CREATE TABLE `fare_204` (
  ...
  `fare_per_km` decimal(5,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
('Mail', 'I class', '1.56'),
('Superfast', 'I class', '1.50'),
('Mail', 'II Class', '2.10'),
('Superfast', 'II Class', '1.56'),
('Mail', 'III Class', '2.10'),
('Superfast', 'III Class', '1.32');
...
INSERT INTO `payment_info_204` (`Transaction_no`, `bank`, `card_no`, `price`, `PNR`) VALUES
...
--
-- Table structure for table `route_info__204`
--

CREATE TABLE `route_info__204` (
...
--
-- Dumping data for table `route_info__204`
--

INSERT INTO `route_info__204` (`from_station_no`, `to_station_no`, `from_station_name`, `to_station_name`, `distance`, `Train_No`) VALUES
...
INSERT INTO `ticket_204` (`PNR`, `Train_No`, `Travel_date`, `departure`, `arrival`, `Departure_time`, `Arrival_time`, `Passenger_id`, `Train_Type`, `compartment_type`, `compartment_No`) VALUES
('PNR001', 62621, '2022-08-07', 'Bengaluru', 'Chennai', '16:00:00', '20:30:00', 'ADM_001', 'Superfast', 'I Class', 'F01\r'),
('PNR002', 62620, '2022-08-14', 'Chennai', 'Bengaluru', '08:00:00', '12:25:00', 'ADM_001', 'Superfast', 'I Class', 'F02\r'),
('PNR003', 25261, '2022-08-01', 'Chennai', 'Mangaluru', '18:00:00', '07:30:00', 'ADM_003', 'Mail', 'III Class', 'G02\r'),
('PNR004', 25260, '2022-08-15', 'Mangaluru', 'Chennai', '19:15:00', '08:00:00', 'ADM_003', 'Mail', 'II Class', 'S02'),
('PNR005', 58451, '2022-08-03', 'Bengaluru', 'Mangaluru', '06:00:00', '14:00:00', 'USR_002', 'Fast', 'III Class', 'G01\r'),
('PNR006', 58450, '2033-08-04', 'Mangaluru', 'Bengaluru', '08:00:00', '10:15:00', 'USR_002', 'Fast', 'II Class', 'S01\r'),
('PNR007', 62621, '2022-08-07', 'Bangarpet', 'Chennai', '18:00:00', '20:30:00', 'ADM_002', 'Superfast', 'II Class', 'S01\r'),
('PNR008', 62620, '2022-08-02', 'Chennai', 'Bangarpet', '08:00:00', '09:00:00', 'ADM_002', 'Superfast', 'I Class', 'F01\r'),
('PNR010', 25260, '2022-08-19', 'Mangaluru', 'Kannur', '19:15:00', '23:15:00', 'USR_007', 'Mail', 'II Class', 'S01'),
('PNR011', 62621, '2022-08-22', 'Katapadi', 'Chennai', '19:00:00', '20:30:00', 'USR_008', 'Superfast', 'I Class', 'F01\r'),
('PNR012', 58451, '2022-08-11', 'Subramanya', 'Mangaluru', '11:00:00', '14:00:00', 'USR_009', 'Fast', 'I Class', 'F01\r'),
('PNR014', 25260, '2022-08-17', 'Kannur', 'Palakkad', '23:15:00', '04:30:00', 'USR_010', 'Mail', 'II Class', 'S01\r'),
('PNR015', 25260, '2022-08-05', 'Palakkad', 'Chennai', '04:30:00', '08:00:00', 'USR_012', 'Mail', 'II Class', 'S01\r');
...
--
-- Table structure for table `user_204`
--

CREATE TABLE `user_204` (
...
--
-- Dumping data for table `user_204`
--

INSERT INTO `user_204` (`User_ID`, `user_type`, `Firstname`, `Lastname`, `age`, `DOB`, `pincode`, `street_number`) VALUES
('ADM_001', 'ADMIN', 'Narendra', 'Modi', 33, '1989-04-14', '600047', 'Old Jail Road'),
('ADM_002', 'ADMIN', 'Droupadi', 'Murmu', 32, '1990-04-14', '640012', 'High Street'),
('ADM_003', 'ADMIN', 'Manmohan', 'Singh', 31, '1991-04-08', '575003', 'Pumpwell Road'),
('USR_001', 'PSGR', 'Ajit', 'Ullal', 51, '1971-01-01', '560001', '10, Janpath'),
('USR_002', 'PSGR', 'Muhammed', 'Ali', 21, '2000-10-09', '560003', '10, Downing'),
('USR_003', 'PSGR', 'Sai Deepak', 'Reddy', 25, '1996-12-12', '600001', '14, Kailsh Marg'),
('USR_004', 'PSGR', 'Rudra', 'Agarwal', 25, '1996-12-13', '600042', '5, Lohia Garden'),
('USR_005', 'PSGR', 'Rahul', 'Khanna', 24, '1997-12-14', '600067', '1, Pink Street'),
('USR_006', 'PSGR', 'Nirmala', 'Seturaman', 23, '1998-12-15', '560105', '3, Blue Avenue'),
('USR_007', 'PSGR', 'Smriti', 'Irani', 22, '1999-12-16', '575014', '4, Banyan Avenie'),
('USR_008', 'PSGR', 'Ajit', 'Sethi', 56, '1966-04-14', '575001', '6, Poes Garden'),
('USR_009', 'PSGR', 'Arjun', 'Allu', 55, '1967-04-08', '575020', '7, Dhamaka street'),
('USR_010', 'PSGR', 'Samanta', 'Prabhu', 54, '1968-04-14', '600042', '8, Clone Colony'),
('USR_011', 'PSGR', 'Kiran', 'Bedi', 53, '1969-04-14', '560003', '56, Brigade Road'),
('USR_012', 'PSGR', 'Rahul', 'Gandhi', 52, '1970-04-08', '475001', 'Mirza road'),
('USR_013', 'PSGR', 'Rashkit', 'Shetty', 51, '1971-04-14', '560009', 'JC Road'),
('USR_014', 'PSGR', 'Rishi', 'Sunak', 50, '1972-04-14', '600034', 'Anna Sali'),
('USR_015', 'PSGR', 'Vedavalli', 'Srinath', 49, '1973-04-14', '560054', 'Church Street, Bangalore'),
('USR_016', 'PSGR', 'Subbu', 'Saravana', 48, '1974-04-14', '600043', 'American Street'),
('USR_017', 'PSGR', 'Sheela', 'Dixit', 47, '1975-04-08', '560048', 'Kasturba Road'),
('USR_018', 'PSGR', 'Margaret', 'Alva', 46, '1976-04-14', '560008', 'New BEL Road'),
('USR_019', 'PSGR', 'Arun', 'Kumar', 45, '1977-04-14', '600046', 'Mint Street'),
('USR_020', 'PSGR', 'Anshu', 'Bhardwaj', 44, '1978-04-14', '575001', 'KSR Road'),
('USR_021', 'PSGR', 'Suma', 'Sampat', 43, '1979-04-08', '560012', 'Old Airport Road, Bangalore'),
('USR_022', 'PSGR', 'Srihari', 'Udupa', 42, '1980-04-14', '560015', 'Suranjan Das Road'),
('USR_023', 'PSGR', 'Satish', 'Kotian', 41, '1981-04-14', '600044', 'T Nagar'),
('USR_024', 'PSGR', 'Shradha', 'Nayar', 40, '1982-04-08', '560006', 'M G Road, Bangalore'),
('USR_025', 'PSGR', 'Manisha', 'Solanki', 39, '1983-04-08', '575030', 'M G Road'),
('USR_026', 'PSGR', 'Bharti', 'Devgan', 38, '1984-04-14', '560059', 'NAL Wind Tunnel Road'),
('USR_027', 'PSGR', 'Roopa', 'Ram', 37, '1985-04-14', '575023', 'Bunder Road'),
('USR_028', 'PSGR', 'Pallavi', 'Ram', 36, '1986-04-08', '560044', 'Lavelle Road'),
('USR_029', 'PSGR', 'Ravi', 'Naik', 35, '1987-04-14', '600045', 'Thiru V ka Salai'),
('USR_030', 'PSGR', 'Virat', 'Murthy', 34, '1988-04-14', '575011', 'Bejai New Road');
...
INSERT INTO `user_phone_204` (`USER`, `phone_no`) VALUES
('ADM_001', '9845012345\r'),
('ADM_001', '9900123456\r'),
('ADM_002', '9845012345\r'),
('ADM_002', '9900123456\r'),
('ADM_003', '9845012345\r'),
('ADM_003', '9900123456\r'),
('USR_001', '9845012345\r'),
('USR_001', '9900123456\r'),
('USR_002', '9845012345\r'),
('USR_002', '9900123456\r'),
('USR_003', '9845012345\r'),
('USR_003', '9900123456\r'),
('USR_004', '9845012345\r'),
('USR_004', '9900123456\r'),
('USR_005', '9845012345\r'),
('USR_005', '9900123456\r'),
('USR_006', '9845012345\r'),
('USR_006', '9900123456\r'),
('USR_007', '9845012345\r'),
('USR_007', '9900123456\r'),
('USR_008', '9845012345\r'),
('USR_008', '9900123456\r'),
('USR_009', '9845012345\r'),
('USR_009', '9900123456\r'),
('USR_010', '9845012345\r'),
('USR_010', '9900123456\r'),
('USR_011', '9845012345\r'),
('USR_011', '9900123456\r'),
('USR_012', '9845012345\r'),
('USR_012', '9900123456\r'),
('USR_013', '9845012345\r'),
('USR_013', '9900123456\r'),
('USR_014', '9845012345\r'),
('USR_014', '9900123456\r'),
('USR_015', '9845012345\r'),
('USR_015', '9900123456\r'),
('USR_016', '9845012345\r'),
('USR_016', '9900123456\r'),
('USR_017', '9845012345\r'),
('USR_017', '9900123456\r'),
('USR_018', '9845012345\r'),
('USR_018', '9900123456\r'),
('USR_019', '9845012345\r'),
('USR_019', '9900123456\r'),
('USR_020', '9845012345\r'),
('USR_020', '9900123456\r'),
('USR_021', '9845012345\r'),
('USR_021', '9900123456\r'),
('USR_022', '9845012345\r'),
('USR_022', '9900123456\r'),
('USR_023', '9845012345\r'),
('USR_023', '9900123456\r'),
('USR_024', '9845012345\r'),
('USR_024', '9900123456\r'),
('USR_025', '9845012345\r'),
('USR_025', '9900123456\r'),
('USR_026', '9845012345\r'),
('USR_026', '9900123456\r'),
('USR_027', '9845012345\r'),
('USR_027', '9900123456\r'),
('USR_028', '9845012345\r'),
('USR_028', '9900123456\r'),
('USR_029', '9845012345\r'),
('USR_029', '9900123456\r'),
('USR_030', '9845012345'),
('USR_030', '9900123456\r');
...
--
-- Indexes for table `route_info__204`
--
ALTER TABLE `route_info__204`
...
ALTER TABLE `ticket_204`
  ...
  ADD KEY `ticket_204_ibfk_3` (`Train_No`);
...
--
-- Indexes for table `user_204`
--
ALTER TABLE `user_204`
...
--
ALTER TABLE `payment_info_204`
  ADD CONSTRAINT `payment_info_204_ibfk_1` FOREIGN KEY (`PNR`) REFERENCES `ticket_204` (`PNR`);

--
-- Constraints for table `route_info__204`
--
ALTER TABLE `route_info__204`
  ADD CONSTRAINT `route_info__204_ibfk_1` FOREIGN KEY (`Train_No`) REFERENCES `train_204` (`Train_no`);

--
-- Constraints for table `ticket_204`
--
ALTER TABLE `ticket_204`
  ADD CONSTRAINT `ticket_204_ibfk_1` FOREIGN KEY (`Passenger_id`) REFERENCES `user_204` (`User_ID`),
  ADD CONSTRAINT `ticket_204_ibfk_2` FOREIGN KEY (`compartment_No`) REFERENCES `compartment_204` (`compartment_no`),
  ADD CONSTRAINT `ticket_204_ibfk_3` FOREIGN KEY (`Train_No`) REFERENCES `train_204` (`Train_no`);

--
-- Constraints for table `ticket_passenger_204`
--
ALTER TABLE `ticket_passenger_204`
  ADD CONSTRAINT `ticket_passenger_204_ibfk_1` FOREIGN KEY (`PNR`) REFERENCES `ticket_204` (`PNR`);

--
-- Constraints for table `user_train_204`
--
ALTER TABLE `user_train_204`
  ADD CONSTRAINT `user_train_204_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user_204` (`User_ID`),
